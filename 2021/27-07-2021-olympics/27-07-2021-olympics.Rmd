...
This is an historical dataset on the modern Olympic Games. As I went through the list of sports, I was surprised to see Tug-Of-War, so I decided to focus on that for my dataset.  
...
```{r tug plot, fig.width = 10, fig.height = 8, fig.align='center', dpi=144, echo=FALSE}
...
tug %>% 
 ...
 geom_text(tug %>% 
  ...
  coord_flip() +
  labs(
    title = "Medals won in Tug-Of-War competitions between 1900-1920",
    y=NULL,
    x=NULL,
    legend = "Type of medal", 
